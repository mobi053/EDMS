...
<script src="{{url('/portal')}}/plugins/datatables/dataTables.buttons.min.js"></script>
<script src="{{url('/portal')}}/plugins/datatables/buttons.bootstrap4.min.js"></script>
<script src="{{url('/portal')}}/plugins/datatables/jszip.min.js"></script>
<script src="{{url('/portal')}}/plugins/datatables/plugins/pdfmake/pdfmake.min.js"></script>
<script src="{{url('/portal')}}/plugins/datatables/plugins/pdfmake/vfs_fonts.js"></script>
<script src="{{url('/portal')}}/plugins/datatables/buttons.html5.min.js"></script>
<script src="{{url('/portal')}}/plugins/datatables/buttons.print.min.js"></script>
<script src="{{url('/portal')}}/plugins/datatables/buttons.colVis.min.js"></script>
