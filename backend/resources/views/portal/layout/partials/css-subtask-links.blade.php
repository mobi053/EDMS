...
<link rel="stylesheet" href="{{url('/portal')}}/plugins/ion-rangeslider/css/ionicons.min.css">

<!--dropzone--->
<!-- <link href="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.5.1/min/dropzone.min.css" rel="stylesheet" /> -->
<link rel="stylesheet" href="{{url('/portal')}}/plugins/dropzone/min/dropzone.min.css">
<!--mycss--->
<link rel="stylesheet" href="{{url('/portal')}}/plugins/mycss/mystyle.css">