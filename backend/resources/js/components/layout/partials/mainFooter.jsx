                ...
                <div className="row g-4 py-4">
                                ...
                                <ul className="nav flex-column">
                                    {categories
                                        ...
                                        .map((category) => (
                                            <li
                                                key={category.id}
                                                className="nav-item mb-2 w-100 collapsed"
                                            >
                                                <Link
                    ...
                    <div className="col-12 col-md-12 col-lg-8">
                        <div className="row g-4">
                            ...
                            <div className="col-6 col-sm-6 col-md-3">
                                <h6 className="mb-4 text-white">Email</h6>
                                {/* list */}
                                <ul className="nav flex-column">
                                    <li className="nav-item mb-2">
                                        info@thefenceline.co.uk
                                    </li>
                                </ul>
                            </div>
                            <div className="col-6 col-sm-6 col-md-3">
                            ...
                            {/* <div className="col-6 col-sm-6 col-md-3">
                                <h6 className="mb-4 text-white">News Letter</h6>
                    ...
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <span className="small text-muted">
                                Copyright 2023 © The Fence line. All rights
                                reserved.
                            </span>
                        </div>
                        <div className="col-md-6">
                            <ul className="list-inline text-md-end mb-0 small mt-3 mt-md-0">
                                ...
                                <li className="list-inline-item me-1">
                                    <a
                                        href="#!"
                                        className="btn btn-xs btn-social btn-icon"
                                    >
                                        {" "}
                                        <svg
